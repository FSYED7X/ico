...
export default function InfoSection({
  ...
  //console.log("Time", new Date().getTime() + (60*60*24*3000))
  const FullMonth = [
    "Jan",
    "Feb",
    "Mar",
      ...
      <StyledPaper sx={{ p: 1, px: 2 }}>
        {React.Children.toArray(
          [
            ...
            {
              left: "Token Price",
              right: `${tokenPrice / 1000000000000000000} BNB per token`,
            },
            {
              left: "Tokens Offered",
              right: `${Number(tokenOffered) / Number(tokenSupply)}% | ${
                Number(tokenOffered) / 10 ** Number(tokenDecimals)
              } Million`, //  "50% | 50,00,00,000",
            },
            {
